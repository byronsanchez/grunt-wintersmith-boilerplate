...
(function() {
  ...
  Environment = (function(_super) {
    ...
    */
    ...
    Environment.prototype.loadModule = function(module) {
    ...
    Environment.prototype.getGraph = function(callback) {
      ...
      */
      ...
      buildGraph = require('./graph').buildGraph;
      return async.waterfall([
        function(callback) {
          return _this.load(callback);
        }, function(result, callback) {
          ...
          contents = result.contents, templates = result.templates, locals = result.locals;
          return buildGraph(_this, contents, templates, locals, callback);
        }
      ], callback);
    };
